"""
Django settings for secured fields project.
...
SECRET_KEY = 'django-insecure-yjhj5&@7&=jv6c)t(0%+o*wt77g7)2ol+a-+dp+129-zk5&j47'
...
DATABASES = {
    'default': env.db('DATABASE_URL', 'postgresql://postgres:P%40ssw0rd@localhost:5432/db'),
}
